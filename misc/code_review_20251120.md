...
- Add argument validation per command (len checks, required ids/messages) and surface failures via `cons.send_error` instead of tracebacks; consider a thin argparse layer to centralize help/usage.
